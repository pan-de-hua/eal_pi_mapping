...
public class JavaMapping_IMAGE_DEL_SENDER_REQ extends AbstractTransformation {
	...
	public void execute(InputStream is, OutputStream os)
		...
		try {
			 ...
			 MT_APP_IMAGE_DEL_SENDER_REQ userObj = JSON.parseObject(outjson,MT_APP_IMAGE_DEL_SENDER_REQ.class);  
