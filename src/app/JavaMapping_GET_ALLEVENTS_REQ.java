...
public class JavaMapping_GET_ALLEVENTS_REQ extends AbstractTransformation {
	...
	public void execute(InputStream is, OutputStream os)
		...
		try {
			 ...
			 MT_WEB_GET_ALLEVENTS_REQ userObj = JSON.parseObject(outjson,MT_WEB_GET_ALLEVENTS_REQ.class);  
